...
// Different displays/screens of the game to be rendered, excludes some screens
...
public class Screen {
    ...
    public static void controlsScreen() {
        ...
        System.out.println();
        System.out.println("Input is case insensitive q and Q are the same. Uppercase is used for brevity.");
        System.out.println();
    ...
    public static void gameOverScreen(int score) {
        ...
        System.out.println();
        System.out.println("Score was: " + Game.GREEN + score + Game.RESET);
